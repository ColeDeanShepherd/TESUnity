...
public class NIFObjectBuilder
{
	...
	private GameObject InstantiateNiNode(NiNode node, GameObject parent)
	{
		...
		obj.transform.localPosition = NifVector3ToUnityVector3(node.translation);
	...
	private GameObject InstantiateNiTriShape(NiTriShape triShape, GameObject parent)
	{
		...
		obj.transform.localPosition = NifVector3ToUnityVector3(triShape.translation);
	...
	private Mesh NiTriShapeDataToMesh(NiTriShapeData data)
	{
		...
		{
			vertices[i] = NifVector3ToUnityVector3(data.vertices[i]);
		}
	...
	private Vector3 NifVector3ToUnityVector3(Vector3 NIFVector3)
	{
		Utils.Swap(ref NIFVector3.y, ref NIFVector3.z);

		return NIFVector3;
	}
	private Quaternion NifMatrix4x4ToUnityQuaternion(Matrix4x4 NIFMatrix4x4)
	{
	...
	private Quaternion RotationMatrixToQuaternion(Matrix4x4 matrix)
	{
